...
def add_target_columns(df:pd.DataFrame,target_coloumn:str=None,forecast_horizon:int=None) -> pd.DataFrame:
    if target_coloumn is None:
        target_coloumn= config.target_coloumb
    
    if forecast_horizon is None:
        forecast_horizon = config.forecast_horzion
...
def get_feature_coloumn(df:pd.DataFrame)-> list[str]:
